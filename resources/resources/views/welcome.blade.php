...
<body id="page-107473" class="">
    ...
    <div class="container page-container"> 
        ...
        <form id="vcglf_coupon_activation_code" novalidate="novalidate">
        ...
        <div class="activation_container">
            <div class="wrapper">
                <form id="vcglf_actication_code" novalidate="novalidate">
                    ...
                    <input type="hidden" id ="activation_codeproduct_id"value>
                </form>
            </div>
            <h1 style="text-align: center" class="custom_heading">Step : Appointment Request Form</h1>
            <div class="sgv-product-add-to-cart-container text-left">
                <form class="sgv-product-add-to-cart" action="" method="post" autocomplete="off">
                    <p> 
                        ...
                        <input id="product_add_to_cart_postal_code" class="form-control sgv-day-picker" type="text" name="product_add_to_cart_postal_code" />
                    </p>
                    <p>
                        <label for="product_add_to_cart_salon">
                            Preferred salon<span class="required">*</span>
                        </label>
                        <input id="product_add_to_cart_salon" class="form-control" type="text" name="product_add_to_cart_salon"  />
                    </p>
                    <p>
                        <label for="product_add_to_cart_treatments">
                            Treatment<span class="required">*</span>
                        </label>
                            <select id="product_add_to_cart_treatments" class="treatments form-control" name="product_add_to_cart_treatments">
                    ...
                    <p>
                        <label for="product_add_to_cart_day_1">
                            Day 1<span class="required">*</span>
                                ...
                                <input id="product_add_to_cart_day_1" class="form-control sgv-day-picker" type="text" name="product_add_to_cart_day_1"  />
